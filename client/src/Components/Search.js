...
//import { get_journeys } from '../redux/interactions';
//import { journeysSelector } from '../redux/selectors';
...
error:null
    ...
    //this.onSuggestionsFromFetchRequested = this.onSuggestionsFromFetchRequested.bind(this);
    //this.onSuggestionsToFetchRequested = this.onSuggestionsToFetchRequested.bind(this);
}
  /////////////////
...
return(
    fetch(`https://api.navitia.io/v1/journeys?key=${key}&from=${fromlatlong}&to=${tolatlong}&datetime=${datetime.toISOString()}`,
    {
      method: 'GET'
...
datetime: new Date()
  ...
  render() {
    const { from, to, fromlatlong, tolatlong, fromSuggestions, toSuggestions } = this.state;
                ...
                <form onSubmit={this.handleSubmit} onChange = {this.handleChange} onReset={this.handleReset}>
                  <label>
                    <Autosuggest
                      ...
                      onSuggestionsFetchRequested={this.onSuggestionsFromFetchRequested}
                      onSuggestionsClearRequested={this.onSuggestionsFromClearRequested}
                  ...
                  <label>
                    <Autosuggest
                      ...
                      onSuggestionsFetchRequested={this.onSuggestionsToFetchRequested}
                      onSuggestionsClearRequested={this.onSuggestionsToClearRequested}
...
//export default connect(mapStateToProps, { getJourneys})(Search);
